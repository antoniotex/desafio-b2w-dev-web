...
module.exports = getProduct = async (pageUrl) => {
  ...
  try{
    await fetch(pageUrl, { headers: {'User-Agent': userAgents }})
     ...
     .then(async productBody => _scraping(productBody))
  }
  catch(error){
    console.log(error)
  }
 ...
 */                              
const _getProductSeller = () => $('.seller-name-container span[class^="seller"]')
                                 .text()
                                 .toLocaleLowerCase()
 ...
 */                                 
const _getProductPrice = () => helpers.convertStringToFloat($('.main-price span[class^="sales-price"]')
                                                      .text()
                                                      .replace("R$", "")
                                                      .replace(".", "")
                                                      .replace(",", ".")
